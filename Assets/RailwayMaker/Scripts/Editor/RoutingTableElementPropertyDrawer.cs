...
namespace MrWhimble.RailwayMaker.Routing
{
    ...
    public class RoutingTableElementPropertyDrawer : PropertyDrawer
    {
            ...
            GUIContent label)
        {
            ...
            //
            //int selectedIndex = GetIndex(property.FindPropertyRelative("waypointName").stringValue, waypointNames);
            //EditorGUI.Popup(position, "Name", selectedIndex, waypointNames);
            //if (selectedIndex != -1)
            //    property.FindPropertyRelative("waypointName").stringValue = waypointNames[selectedIndex];
            //position.y += 20;
